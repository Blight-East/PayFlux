            ...
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="text-center md:text-left">
                    <p className="text-slate-600 text-[10px] font-bold uppercase tracking-[0.3em]">
                        © 2026 PayFlux Infrastructure.
                    </p>
                    <p className="text-slate-700 text-[10px] font-bold uppercase tracking-[0.2em] mt-2">
                        Signals preserved for audit-ready review.
                    </p>
                </div>

                <div className="flex gap-6 text-[11px] font-bold uppercase tracking-[0.2em] text-slate-500">
