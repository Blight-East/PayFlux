 ...
 *
 * Client-side polling still handles transient state changes (e.g., pipeline
 * completing mid-view), but the initial render is guaranteed to be for a
 * connected_generating user.
 */
