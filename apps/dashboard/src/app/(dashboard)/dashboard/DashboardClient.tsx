...
export default function DashboardClient({ tier, host }: { tier: string; host: string | null }) {
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto">
            ...
            {/* ═══════════════════════════════════════════════════════════════
                PRIMARY INSTRUMENT — Capital At Risk Projection
                This is the first visual contact. Everything below is telemetry.
               ═══════════════════════════════════════════════════════════════ */}
            <div className="mb-12">
            ...
            {/* ═══════════════════════════════════════════════════════════════
                SECONDARY TELEMETRY — Supporting signals
