...
export default function ConnectProcessorPage() {
    ...
    const validateApiKey = (value: string) => {
        ...
        if (!value.startsWith('sk_')) return 'Must start with sk_test_ or sk_live_';
        return null;
    };
    ...
    const handleContinue = () => {
        ...
        // Store in sessionStorage (browser only, never server)
    ...
    return (
        <div className="p-8 max-w-2xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-zinc-500 text-sm mt-1">Enter your Stripe credentials. These are used locally only.</p>
            </div>
