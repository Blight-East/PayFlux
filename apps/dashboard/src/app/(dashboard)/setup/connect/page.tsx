...
export default function ConnectProcessorPage() {
    ...
    return (
        <div className="p-8 max-w-2xl mx-auto">
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-lg p-6 space-y-6">
                {processor === 'stripe' ? (
                    ...
                    <>
                        ...
                        <div>
                            ...
                            <input
                                type="password"
                                className={`w-full bg-slate-950 border rounded px-3 py-2 text-white text-sm focus:outline-none transition-colors ${errors.webhook ? 'border-red-500' : 'border-slate-800 focus:border-blue-500'
                                    }`}
                        ...
                        <div>
                            ...
                            <input
                                type="password"
                                className={`w-full bg-slate-950 border rounded px-3 py-2 text-white text-sm focus:outline-none transition-colors ${errors.api ? 'border-red-500' : 'border-slate-800 focus:border-blue-500'
                                    }`}
